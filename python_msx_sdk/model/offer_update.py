...
class OfferUpdate(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, label, description, product_id, version, display_order, image, supported_properties, supported_options, *args, **kwargs):  # noqa: E501
