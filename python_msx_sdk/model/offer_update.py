...
class OfferUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, label, description, product_id, version, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, label, description, product_id, version, *args, **kwargs):  # noqa: E501
        """OfferUpdate - a model defined in OpenAPI
