...
class WorkflowTargetsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_workflow_target_endpoint = _Endpoint(
            settings={
        ...
        self.delete_workflow_target_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
        ...
        self.get_workflow_target_endpoint = _Endpoint(
            settings={
                'response_type': (WorkflowTarget,),
                'auth': [],
                'endpoint_path': '/workflow/api/v8/targets/{id}',
        ...
        self.get_workflow_targets_list_endpoint = _Endpoint(
            settings={
                'response_type': ([WorkflowTarget],),
                'auth': [],
        ...
        self.update_workflow_target_endpoint = _Endpoint(
            settings={
                'response_type': (WorkflowTarget,),
                'auth': [],
                'endpoint_path': '/workflow/api/v8/targets/{id}',
    ...
    def create_workflow_target(
        ...
        **kwargs
        ...
        kwargs['workflow_target_create'] = \
            workflow_target_create
        return self.create_workflow_target_endpoint.call_with_http_info(**kwargs)

    def delete_workflow_target(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.delete_workflow_target_endpoint.call_with_http_info(**kwargs)
    ...
    def get_workflow_target(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_workflow_target_endpoint.call_with_http_info(**kwargs)

    def get_workflow_targets_list(
        self,
        **kwargs
    ):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_workflow_targets_list_endpoint.call_with_http_info(**kwargs)

    def update_workflow_target(
        self,
        id,
        workflow_target_update,
        **kwargs
        ...
        kwargs['workflow_target_update'] = \
            workflow_target_update
        return self.update_workflow_target_endpoint.call_with_http_info(**kwargs)
