...
class TenantsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_tenant_by_external_id_endpoint = _Endpoint(
            settings={
                'response_type': (Tenant,),
                'auth': [],
                'endpoint_path': '/idm/api/v8/tenants/externalId/{externalId}',
                'operation_id': 'get_tenant_by_external_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_tenants_list_endpoint = _Endpoint(
            settings={
                'response_type': ([Tenant],),
                'auth': [],
        ...
        self.get_tenants_page_endpoint = _Endpoint(
            settings={
    ...
    def get_tenant_by_external_id(
        ...
        **kwargs
        ...
        """Returns a tenant by externalId.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_tenant_by_external_id(external_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['external_id'] = \
            external_id
        return self.get_tenant_by_external_id_endpoint.call_with_http_info(**kwargs)
    ...
    def get_tenants_list(
        ...
        **kwargs
        ...
        kwargs['ids'] = \
            ids
        return self.get_tenants_list_endpoint.call_with_http_info(**kwargs)
    ...
    def get_tenants_page(
        ...
        **kwargs
        ...
        kwargs['page_size'] = \
            page_size
        return self.get_tenants_page_endpoint.call_with_http_info(**kwargs)
