...
class SitesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.add_devices_to_site_endpoint = _Endpoint(
            settings={
                'response_type': (Site,),
                'auth': [],
        ...
        self.add_services_to_site_endpoint = _Endpoint(
            settings={
                'response_type': (Site,),
                'auth': [],
        ...
        self.get_site_endpoint = _Endpoint(
            settings={
                'response_type': (Site,),
                'auth': [],
                'endpoint_path': '/manage/api/v8/sites/{id}',
        ...
        self.get_sites_page_endpoint = _Endpoint(
            settings={
        ...
        self.remove_devices_from_site_endpoint = _Endpoint(
            settings={
                'response_type': (Site,),
                'auth': [],
        ...
        self.remove_services_from_site_endpoint = _Endpoint(
            settings={
                'response_type': (Site,),
                'auth': [],
    ...
    def add_devices_to_site(
        ...
        **kwargs
        ...
        kwargs['request_body'] = \
            request_body
        return self.add_devices_to_site_endpoint.call_with_http_info(**kwargs)

    def add_services_to_site(
        self,
        id,
        request_body,
        **kwargs
        ...
        kwargs['request_body'] = \
            request_body
        return self.add_services_to_site_endpoint.call_with_http_info(**kwargs)
    ...
    def get_site(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_site_endpoint.call_with_http_info(**kwargs)
    ...
    def get_sites_page(
        ...
        **kwargs
        ...
        kwargs['page_size'] = \
            page_size
        return self.get_sites_page_endpoint.call_with_http_info(**kwargs)

    def remove_devices_from_site(
        self,
        id,
        request_body,
        **kwargs
        ...
        kwargs['request_body'] = \
            request_body
        return self.remove_devices_from_site_endpoint.call_with_http_info(**kwargs)

    def remove_services_from_site(
        self,
        id,
        request_body,
        **kwargs
        ...
        kwargs['request_body'] = \
            request_body
        return self.remove_services_from_site_endpoint.call_with_http_info(**kwargs)
