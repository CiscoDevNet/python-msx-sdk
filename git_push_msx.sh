...
#
# Usage example: /bin/bash git_push_msx.sh python-msx-sdk v1.0.1 `cat ~/.ssh/personal_access_token`
...
if [ "$git_token" = "" ]; then
    ...
    echo "[INFO] No command line input provided. Set \$release_tag to $git_token"
    exit
fi
